...
## numpy.clip possibly to cap poppulation at 0
...
### ha.plot_surface(X, Y, potential,alpha=1, cmap='Purples')
##ha.plot_surface(X, Y, potential_surface)
##plt.show()
####
##
...
##out_raster.GetRasterBand(1).WriteArray(pop_downscaled)
